...
TextBlob is an open source Python library for performing simple  language processing tasks. Using this library, we are trying to make  the underlying structure of language available to computer programs for analysis and manipulation. Textblob provides a simple API for common natural language processing (NLP) tasks. 
...
\begin{itemize}  
\item Need to create a TextBlob object. It gives a string with the text we want to work with.
